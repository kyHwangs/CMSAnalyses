...
def getOptions():
    ...
    parser.add_option('-f', '--configFile',
                      dest = 'configFile',
                      default = os.path.join(os.environ['CMSSW_BASE'], 'src/CMSAnalyses/SSBAnalyzer/config/ssbanalyzer_bg_cfg.py'),
...
def main():
    ...
    if crabCmd == 'submit':
        ...
        sample_db = os.path.join(os.environ['CMSSW_BASE'], "src/CMSAnalyses/SSBAnalyzer/dataset", "database.json")
