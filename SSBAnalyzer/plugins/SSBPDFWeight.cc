...
SSBPDFWeight::SSBPDFWeight(int npdfset, std::string pdfname) { LHAPDF::initPDFSet(npdfset, pdfname); }
...
void SSBPDFWeight::UsePDF(int nset, int member) { LHAPDF::usePDFMember(nset, member); }
