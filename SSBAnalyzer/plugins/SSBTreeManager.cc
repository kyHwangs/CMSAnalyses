...
void SSBTreeManager::Fill(st VariableName, bool VariableBool) {
  if ((it_VariableBox_Bool = VariableBox_Bool.find(VariableName.c_str())) != VariableBox_Bool.end()) {
    ...
    // std::cout << "Fill Bool vector : " << VariableName << " - " << VariableBool << std::endl;
...
void SSBTreeManager::Fill(st VariableName, double VariableDouble) {
  if ((it_VariableBox_Double = VariableBox_Double.find(VariableName.c_str())) != VariableBox_Double.end()) {
    ...
    // std::cout << "Fill Double variable : " << VariableName << " - " << VariableDouble << std::endl;
    ...
    // std::cout << "Fill Double vector : " << VariableName << " - " << VariableDouble << std::endl;
  } else {
...
void SSBTreeManager::Book(TTree *tree) {
  ...
  ssbtree->Branch("LHE_nParticle", &VariableBox_Int["LHE_nParticle"], "LHE_nParticle/I");
  
  ssbtree->Branch("LHE_particleID", &VectorBox_Int["LHE_particleID"]);
  ssbtree->Branch("LHE_Status", &VectorBox_Int["LHE_Status"]);
  ssbtree->Branch("LHE_Px", &VectorBox_Double["LHE_Px"]);
  ssbtree->Branch("LHE_Py", &VectorBox_Double["LHE_Py"]);
  ssbtree->Branch("LHE_Pz", &VectorBox_Double["LHE_Pz"]);
  ssbtree->Branch("LHE_E", &VectorBox_Double["LHE_E"]);
  ...
  // ssbtree->Branch("Elec_MVATrig_Tight",
  // &VectorBox_Bool["Elec_MVATrig_Tight"]);
  // ssbtree->Branch("Elec_MVA_NonTrigV0",
  // &VectorBox_Float["Elec_MVA_NonTrigV0"]);
  // ssbtree->Branch("Elec_MVA_TrigNoIPV0",
  // &VectorBox_Float["Elec_MVA_TrigNoIPV0"]);
  ...
  ssbtree->Branch("Elec_Rnd", &VectorBox_Double["Elec_Rnd"]);
  ...
  // ssbtree->Branch("MET_JetEnShiftedUp_PT",
  // &VectorBox_Double["MET_JetEnShiftedUp_PT"]);
  // ssbtree->Branch("MET_JetEnShiftedUp_Phi",
  // &VectorBox_Double["MET_JetEnShiftedUp_Phi"]);
  // ssbtree->Branch("MET_JetEnShiftedDown_PT",
  // &VectorBox_Double["MET_JetEnShiftedDown_PT"]);
  // ssbtree->Branch("MET_JetEnShiftedDown_Phi",
  // &VectorBox_Double["MET_JetEnShiftedDown_Phi"]);
  // ssbtree->Branch("MET_MuonEnShiftedUp_PT",
  // &VectorBox_Double["MET_MuonEnShiftedUp_PT"]);
  // ssbtree->Branch("MET_MuonEnShiftedUp_Phi",
  // &VectorBox_Double["MET_MuonEnShiftedUp_Phi"]);
  // ssbtree->Branch("MET_MuonEnShiftedDown_PT",
  // &VectorBox_Double["MET_MuonEnShiftedDown_PT"]);
  // ssbtree->Branch("MET_MuonEnShiftedDown_Phi",
  // &VectorBox_Double["MET_MuonEnShiftedDown_Phi"]);
  // ssbtree->Branch("MET_ElectronEnShiftedUp_PT",
  // &VectorBox_Double["MET_ElectronEnShiftedUp_PT"]);
  // ssbtree->Branch("MET_ElectronEnShiftedUp_Phi",
  // &VectorBox_Double["MET_ElectronEnShiftedUp_Phi"]);
  // ssbtree->Branch("MET_ElectronEnShiftedDown_PT",
  // &VectorBox_Double["MET_ElectronEnShiftedDown_PT"]);
  // ssbtree->Branch("MET_ElectronEnShiftedDown_Phi",
  // &VectorBox_Double["MET_ElectronEnShiftedDown_Phi"]);
  // ssbtree->Branch("MET_UnclusteredEnShiftedUp_PT",
  // &VectorBox_Double["MET_UnclusteredEnShiftedUp_PT"]);
  // ssbtree->Branch("MET_UnclusteredEnShiftedUp_Phi",
  // &VectorBox_Double["MET_UnclusteredEnShiftedUp_Phi"]);
  // ssbtree->Branch("MET_UnclusteredEnShiftedDown_PT",
  // &VectorBox_Double["MET_UnclusteredEnShiftedDown_PT"]);
  // ssbtree->Branch("MET_UnclusteredEnShiftedDown_Phi",
  // &VectorBox_Double["MET_UnclusteredEnShiftedDown_Phi"]);
  // ssbtree->Branch("MET_JetResShiftedUp_PT",
  // &VectorBox_Double["MET_JetResShiftedUp_PT"]);
  // ssbtree->Branch("MET_JetResShiftedUp_Phi",
  // &VectorBox_Double["MET_JetResShiftedUp_Phi"]);
  // ssbtree->Branch("MET_JetResShiftedDown_PT",
  // &VectorBox_Double["MET_JetResShiftedDown_PT"]);
  // ssbtree->Branch("MET_JetResShiftedDown_Phi",
  // &VectorBox_Double["MET_JetResShiftedDown_Phi"]);

  // ssbtree->Branch("METEGClean", "TClonesArray",
  // &VariableBox_LorentzVector["METEGClean"], 32000, 0);
  // VariableBox_LorentzVector["METEGClean"]->BypassStreamer();
  // ssbtree->Branch("METEGClean_Significance",
  // &VariableBox_Double["METEGClean_Significance"],
  // "METEGClean_Significance/D");
  // ssbtree->Branch("METEGClean_JetEnShiftedUp_PT",
  // &VectorBox_Double["METEGClean_JetEnShiftedUp_PT"]);
  // ssbtree->Branch("METEGClean_JetEnShiftedUp_Phi",
  // &VectorBox_Double["METEGClean_JetEnShiftedUp_Phi"]);
  // ssbtree->Branch("METEGClean_JetEnShiftedDown_PT",
  // &VectorBox_Double["METEGClean_JetEnShiftedDown_PT"]);
  // ssbtree->Branch("METEGClean_JetEnShiftedDown_Phi",
  // &VectorBox_Double["METEGClean_JetEnShiftedDown_Phi"]);
  // ssbtree->Branch("METEGClean_MuonEnShiftedUp_PT",
  // &VectorBox_Double["METEGClean_MuonEnShiftedUp_PT"]);
  // ssbtree->Branch("METEGClean_MuonEnShiftedUp_Phi",
  // &VectorBox_Double["METEGClean_MuonEnShiftedUp_Phi"]);
  // ssbtree->Branch("METEGClean_MuonEnShiftedDown_PT",
  // &VectorBox_Double["METEGClean_MuonEnShiftedDown_PT"]);
  // ssbtree->Branch("METEGClean_MuonEnShiftedDown_Phi",
  // &VectorBox_Double["METEGClean_MuonEnShiftedDown_Phi"]);
  // ssbtree->Branch("METEGClean_ElectronEnShiftedUp_PT",
  // &VectorBox_Double["METEGClean_ElectronEnShiftedUp_PT"]);
  // ssbtree->Branch("METEGClean_ElectronEnShiftedUp_Phi",
  // &VectorBox_Double["METEGClean_ElectronEnShiftedUp_Phi"]);
  // ssbtree->Branch("METEGClean_ElectronEnShiftedDown_PT",
  // &VectorBox_Double["METEGClean_ElectronEnShiftedDown_PT"]);
  // ssbtree->Branch("METEGClean_ElectronEnShiftedDown_Phi",
  // &VectorBox_Double["METEGClean_ElectronEnShiftedDown_Phi"]);
  // ssbtree->Branch("METEGClean_UnclusteredEnShiftedUp_PT",
  // &VectorBox_Double["METEGClean_UnclusteredEnShiftedUp_PT"]);
  // ssbtree->Branch("METEGClean_UnclusteredEnShiftedUp_Phi",
  // &VectorBox_Double["METEGClean_UnclusteredEnShiftedUp_Phi"]);
  // ssbtree->Branch("METEGClean_UnclusteredEnShiftedDown_PT",
  // &VectorBox_Double["METEGClean_UnclusteredEnShiftedDown_PT"]);
  // ssbtree->Branch("METEGClean_UnclusteredEnShiftedDown_Phi",
  // &VectorBox_Double["METEGClean_UnclusteredEnShiftedDown_Phi"]);
  // ssbtree->Branch("METEGClean_JetResShiftedUp_PT",
  // &VectorBox_Double["METEGClean_JetResShiftedUp_PT"]);
  // ssbtree->Branch("METEGClean_JetResShiftedUp_Phi",
  // &VectorBox_Double["METEGClean_JetResShiftedUp_Phi"]);
  // ssbtree->Branch("METEGClean_JetResShiftedDown_PT",
  // &VectorBox_Double["METEGClean_JetResShiftedDown_PT"]);
  // ssbtree->Branch("METEGClean_JetResShiftedDown_Phi",
  // &VectorBox_Double["METEGClean_JetResShiftedDown_Phi"]);

  // ssbtree->Branch("METMUEGClean", "TClonesArray",
  // &VariableBox_LorentzVector["METMUEGClean"], 32000, 0);
  // VariableBox_LorentzVector["METMUEGClean"]->BypassStreamer();
  // ssbtree->Branch("METMUEGClean_Significance",
  // &VariableBox_Double["METMUEGClean_Significance"],
  // "METMUEGClean_Significance/D");
  // ssbtree->Branch("METMUEGClean_JetEnShiftedUp_PT",
  // &VectorBox_Double["METMUEGClean_JetEnShiftedUp_PT"]);
  // ssbtree->Branch("METMUEGClean_JetEnShiftedUp_Phi",
  // &VectorBox_Double["METMUEGClean_JetEnShiftedUp_Phi"]);
  // ssbtree->Branch("METMUEGClean_JetEnShiftedDown_PT",
  // &VectorBox_Double["METMUEGClean_JetEnShiftedDown_PT"]);
  // ssbtree->Branch("METMUEGClean_JetEnShiftedDown_Phi",
  // &VectorBox_Double["METMUEGClean_JetEnShiftedDown_Phi"]);
  // ssbtree->Branch("METMUEGClean_MuonEnShiftedUp_PT",
  // &VectorBox_Double["METMUEGClean_MuonEnShiftedUp_PT"]);
  // ssbtree->Branch("METMUEGClean_MuonEnShiftedUp_Phi",
  // &VectorBox_Double["METMUEGClean_MuonEnShiftedUp_Phi"]);
  // ssbtree->Branch("METMUEGClean_MuonEnShiftedDown_PT",
  // &VectorBox_Double["METMUEGClean_MuonEnShiftedDown_PT"]);
  // ssbtree->Branch("METMUEGClean_MuonEnShiftedDown_Phi",
  // &VectorBox_Double["METMUEGClean_MuonEnShiftedDown_Phi"]);
  // ssbtree->Branch("METMUEGClean_ElectronEnShiftedUp_PT",
  // &VectorBox_Double["METMUEGClean_ElectronEnShiftedUp_PT"]);
  // ssbtree->Branch("METMUEGClean_ElectronEnShiftedUp_Phi",
  // &VectorBox_Double["METMUEGClean_ElectronEnShiftedUp_Phi"]);
  // ssbtree->Branch("METMUEGClean_ElectronEnShiftedDown_PT",
  // &VectorBox_Double["METMUEGClean_ElectronEnShiftedDown_PT"]);
  // ssbtree->Branch("METMUEGClean_ElectronEnShiftedDown_Phi",
  // &VectorBox_Double["METMUEGClean_ElectronEnShiftedDown_Phi"]);
  // ssbtree->Branch("METMUEGClean_UnclusteredEnShiftedUp_PT",
  // &VectorBox_Double["METMUEGClean_UnclusteredEnShiftedUp_PT"]);
  // ssbtree->Branch("METMUEGClean_UnclusteredEnShiftedUp_Phi",
  // &VectorBox_Double["METMUEGClean_UnclusteredEnShiftedUp_Phi"]);
  // ssbtree->Branch("METMUEGClean_UnclusteredEnShiftedDown_PT",
  // &VectorBox_Double["METMUEGClean_UnclusteredEnShiftedDown_PT"]);
  // ssbtree->Branch("METMUEGClean_UnclusteredEnShiftedDown_Phi",
  // &VectorBox_Double["METMUEGClean_UnclusteredEnShiftedDown_Phi"]);
  // ssbtree->Branch("METMUEGClean_JetResShiftedUp_PT",
  // &VectorBox_Double["METMUEGClean_JetResShiftedUp_PT"]);
  // ssbtree->Branch("METMUEGClean_JetResShiftedUp_Phi",
  // &VectorBox_Double["METMUEGClean_JetResShiftedUp_Phi"]);
  // ssbtree->Branch("METMUEGClean_JetResShiftedDown_PT",
  // &VectorBox_Double["METMUEGClean_JetResShiftedDown_PT"]);
  // ssbtree->Branch("METMUEGClean_JetResShiftedDown_Phi",
  // &VectorBox_Double["METMUEGClean_JetResShiftedDown_Phi"]);

  // ssbtree->Branch("METMUEGCleanCor", "TClonesArray",
  // &VariableBox_LorentzVector["METMUEGCleanCor"], 32000, 0);
  // VariableBox_LorentzVector["METMUEGCleanCor"]->BypassStreamer();
  // ssbtree->Branch("METMUEGCleanCor_Significance",
  // &VariableBox_Double["METMUEGCleanCor_Significance"],
  // "METMUEGCleanCor_Significance/D");
  // ssbtree->Branch("METMUEGCleanCor_JetEnShiftedUp_PT",
  // &VectorBox_Double["METMUEGCleanCor_JetEnShiftedUp_PT"]);
  // ssbtree->Branch("METMUEGCleanCor_JetEnShiftedUp_Phi",
  // &VectorBox_Double["METMUEGCleanCor_JetEnShiftedUp_Phi"]);
  // ssbtree->Branch("METMUEGCleanCor_JetEnShiftedDown_PT",
  // &VectorBox_Double["METMUEGCleanCor_JetEnShiftedDown_PT"]);
  // ssbtree->Branch("METMUEGCleanCor_JetEnShiftedDown_Phi",
  // &VectorBox_Double["METMUEGCleanCor_JetEnShiftedDown_Phi"]);
  // ssbtree->Branch("METMUEGCleanCor_MuonEnShiftedUp_PT",
  // &VectorBox_Double["METMUEGCleanCor_MuonEnShiftedUp_PT"]);
  // ssbtree->Branch("METMUEGCleanCor_MuonEnShiftedUp_Phi",
  // &VectorBox_Double["METMUEGCleanCor_MuonEnShiftedUp_Phi"]);
  // ssbtree->Branch("METMUEGCleanCor_MuonEnShiftedDown_PT",
  // &VectorBox_Double["METMUEGCleanCor_MuonEnShiftedDown_PT"]);
  // ssbtree->Branch("METMUEGCleanCor_MuonEnShiftedDown_Phi",
  // &VectorBox_Double["METMUEGCleanCor_MuonEnShiftedDown_Phi"]);
  // ssbtree->Branch("METMUEGCleanCor_ElectronEnShiftedUp_PT",
  // &VectorBox_Double["METMUEGCleanCor_ElectronEnShiftedUp_PT"]);
  // ssbtree->Branch("METMUEGCleanCor_ElectronEnShiftedUp_Phi",
  // &VectorBox_Double["METMUEGCleanCor_ElectronEnShiftedUp_Phi"]);
  // ssbtree->Branch("METMUEGCleanCor_ElectronEnShiftedDown_PT",
  // &VectorBox_Double["METMUEGCleanCor_ElectronEnShiftedDown_PT"]);
  // ssbtree->Branch("METMUEGCleanCor_ElectronEnShiftedDown_Phi",
  // &VectorBox_Double["METMUEGCleanCor_ElectronEnShiftedDown_Phi"]);
  // ssbtree->Branch("METMUEGCleanCor_UnclusteredEnShiftedUp_PT",
  // &VectorBox_Double["METMUEGCleanCor_UnclusteredEnShiftedUp_PT"]);
  // ssbtree->Branch("METMUEGCleanCor_UnclusteredEnShiftedUp_Phi",
  // &VectorBox_Double["METMUEGCleanCor_UnclusteredEnShiftedUp_Phi"]);
  // ssbtree->Branch("METMUEGCleanCor_UnclusteredEnShiftedDown_PT",
  // &VectorBox_Double["METMUEGCleanCor_UnclusteredEnShiftedDown_PT"]);
  // ssbtree->Branch("METMUEGCleanCor_UnclusteredEnShiftedDown_Phi",
  // &VectorBox_Double["METMUEGCleanCor_UnclusteredEnShiftedDown_Phi"]);
  // ssbtree->Branch("METMUEGCleanCor_JetResShiftedUp_PT",
  // &VectorBox_Double["METMUEGCleanCor_JetResShiftedUp_PT"]);
  // ssbtree->Branch("METMUEGCleanCor_JetResShiftedUp_Phi",
  // &VectorBox_Double["METMUEGCleanCor_JetResShiftedUp_Phi"]);
  // ssbtree->Branch("METMUEGCleanCor_JetResShiftedDown_PT",
  // &VectorBox_Double["METMUEGCleanCor_JetResShiftedDown_PT"]);
  // ssbtree->Branch("METMUEGCleanCor_JetResShiftedDown_Phi",
  // &VectorBox_Double["METMUEGCleanCor_JetResShiftedDown_Phi"]);

  // ssbtree->Branch("METMUCleanCor", "TClonesArray",
  // &VariableBox_LorentzVector["METMUCleanCor"], 32000, 0);
  // VariableBox_LorentzVector["METMUCleanCor"]->BypassStreamer();
  // ssbtree->Branch("METMUCleanCor_Significance",
  // &VariableBox_Double["METMUCleanCor_Significance"],
  // "METMUCleanCor_Significance/D");
  // ssbtree->Branch("METMUCleanCor_JetEnShiftedUp_PT",
  // &VectorBox_Double["METMUCleanCor_JetEnShiftedUp_PT"]);
  // ssbtree->Branch("METMUCleanCor_JetEnShiftedUp_Phi",
  // &VectorBox_Double["METMUCleanCor_JetEnShiftedUp_Phi"]);
  // ssbtree->Branch("METMUCleanCor_JetEnShiftedDown_PT",
  // &VectorBox_Double["METMUCleanCor_JetEnShiftedDown_PT"]);
  // ssbtree->Branch("METMUCleanCor_JetEnShiftedDown_Phi",
  // &VectorBox_Double["METMUCleanCor_JetEnShiftedDown_Phi"]);
  // ssbtree->Branch("METMUCleanCor_MuonEnShiftedUp_PT",
  // &VectorBox_Double["METMUCleanCor_MuonEnShiftedUp_PT"]);
  // ssbtree->Branch("METMUCleanCor_MuonEnShiftedUp_Phi",
  // &VectorBox_Double["METMUCleanCor_MuonEnShiftedUp_Phi"]);
  // ssbtree->Branch("METMUCleanCor_MuonEnShiftedDown_PT",
  // &VectorBox_Double["METMUCleanCor_MuonEnShiftedDown_PT"]);
  // ssbtree->Branch("METMUCleanCor_MuonEnShiftedDown_Phi",
  // &VectorBox_Double["METMUCleanCor_MuonEnShiftedDown_Phi"]);
  // ssbtree->Branch("METMUCleanCor_ElectronEnShiftedUp_PT",
  // &VectorBox_Double["METMUCleanCor_ElectronEnShiftedUp_PT"]);
  // ssbtree->Branch("METMUCleanCor_ElectronEnShiftedUp_Phi",
  // &VectorBox_Double["METMUCleanCor_ElectronEnShiftedUp_Phi"]);
  // ssbtree->Branch("METMUCleanCor_ElectronEnShiftedDown_PT",
  // &VectorBox_Double["METMUCleanCor_ElectronEnShiftedDown_PT"]);
  // ssbtree->Branch("METMUCleanCor_ElectronEnShiftedDown_Phi",
  // &VectorBox_Double["METMUCleanCor_ElectronEnShiftedDown_Phi"]);
  // ssbtree->Branch("METMUCleanCor_UnclusteredEnShiftedUp_PT",
  // &VectorBox_Double["METMUCleanCor_UnclusteredEnShiftedUp_PT"]);
  // ssbtree->Branch("METMUCleanCor_UnclusteredEnShiftedUp_Phi",
  // &VectorBox_Double["METMUCleanCor_UnclusteredEnShiftedUp_Phi"]);
  // ssbtree->Branch("METMUCleanCor_UnclusteredEnShiftedDown_PT",
  // &VectorBox_Double["METMUCleanCor_UnclusteredEnShiftedDown_PT"]);
  // ssbtree->Branch("METMUCleanCor_UnclusteredEnShiftedDown_Phi",
  // &VectorBox_Double["METMUCleanCor_UnclusteredEnShiftedDown_Phi"]);
  // ssbtree->Branch("METMUCleanCor_JetResShiftedUp_PT",
  // &VectorBox_Double["METMUCleanCor_JetResShiftedUp_PT"]);
  // ssbtree->Branch("METMUCleanCor_JetResShiftedUp_Phi",
  // &VectorBox_Double["METMUCleanCor_JetResShiftedUp_Phi"]);
  // ssbtree->Branch("METMUCleanCor_JetResShiftedDown_PT",
  // &VectorBox_Double["METMUCleanCor_JetResShiftedDown_PT"]);
  // ssbtree->Branch("METMUCleanCor_JetResShiftedDown_Phi",
  // &VectorBox_Double["METMUCleanCor_JetResShiftedDown_Phi"]);

  // ssbtree->Branch("METUnCor", "TClonesArray",
  // &VariableBox_LorentzVector["METUnCor"], 32000, 0);
  // VariableBox_LorentzVector["METUnCor"]->BypassStreamer();
  // ssbtree->Branch("METUnCor_Significance",
  // &VariableBox_Double["METUnCor_Significance"], "METUnCor_Significance/D");
  // ssbtree->Branch("METUnCor_JetEnShiftedUp_PT",
  // &VectorBox_Double["METUnCor_JetEnShiftedUp_PT"]);
  // ssbtree->Branch("METUnCor_JetEnShiftedUp_Phi",
  // &VectorBox_Double["METUnCor_JetEnShiftedUp_Phi"]);
  // ssbtree->Branch("METUnCor_JetEnShiftedDown_PT",
  // &VectorBox_Double["METUnCor_JetEnShiftedDown_PT"]);
  // ssbtree->Branch("METUnCor_JetEnShiftedDown_Phi",
  // &VectorBox_Double["METUnCor_JetEnShiftedDown_Phi"]);
  // ssbtree->Branch("METUnCor_MuonEnShiftedUp_PT",
  // &VectorBox_Double["METUnCor_MuonEnShiftedUp_PT"]);
  // ssbtree->Branch("METUnCor_MuonEnShiftedUp_Phi",
  // &VectorBox_Double["METUnCor_MuonEnShiftedUp_Phi"]);
  // ssbtree->Branch("METUnCor_MuonEnShiftedDown_PT",
  // &VectorBox_Double["METUnCor_MuonEnShiftedDown_PT"]);
  // ssbtree->Branch("METUnCor_MuonEnShiftedDown_Phi",
  // &VectorBox_Double["METUnCor_MuonEnShiftedDown_Phi"]);
  // ssbtree->Branch("METUnCor_ElectronEnShiftedUp_PT",
  // &VectorBox_Double["METUnCor_ElectronEnShiftedUp_PT"]);
  // ssbtree->Branch("METUnCor_ElectronEnShiftedUp_Phi",
  // &VectorBox_Double["METUnCor_ElectronEnShiftedUp_Phi"]);
  // ssbtree->Branch("METUnCor_ElectronEnShiftedDown_PT",
  // &VectorBox_Double["METUnCor_ElectronEnShiftedDown_PT"]);
  // ssbtree->Branch("METUnCor_ElectronEnShiftedDown_Phi",
  // &VectorBox_Double["METUnCor_ElectronEnShiftedDown_Phi"]);
  // ssbtree->Branch("METUnCor_UnclusteredEnShiftedUp_PT",
  // &VectorBox_Double["METUnCor_UnclusteredEnShiftedUp_PT"]);
  // ssbtree->Branch("METUnCor_UnclusteredEnShiftedUp_Phi",
  // &VectorBox_Double["METUnCor_UnclusteredEnShiftedUp_Phi"]);
  // ssbtree->Branch("METUnCor_UnclusteredEnShiftedDown_PT",
  // &VectorBox_Double["METUnCor_UnclusteredEnShiftedDown_PT"]);
  // ssbtree->Branch("METUnCor_UnclusteredEnShiftedDown_Phi",
  // &VectorBox_Double["METUnCor_UnclusteredEnShiftedDown_Phi"]);
  // ssbtree->Branch("METUnCor_JetResShiftedUp_PT",
  // &VectorBox_Double["METUnCor_JetResShiftedUp_PT"]);
  // ssbtree->Branch("METUnCor_JetResShiftedUp_Phi",
  // &VectorBox_Double["METUnCor_JetResShiftedUp_Phi"]);
  // ssbtree->Branch("METUnCor_JetResShiftedDown_PT",
  // &VectorBox_Double["METUnCor_JetResShiftedDown_PT"]);
  // ssbtree->Branch("METUnCor_JetResShiftedDown_Phi",
  // &VectorBox_Double["METUnCor_JetResShiftedDown_Phi"]);
  ...
  ssbtree->Branch("hasPV", &VariableBox_Bool["hasPV"], "hasPV/B");
...
void SSBTreeManager::InitializeVariables() {
  ...
  VariableBox_Int["LHE_nParticle"] = 0;
  VectorBox_Int["LHE_particleID"].clear();
  VectorBox_Int["LHE_Status"].clear();
  VectorBox_Double["LHE_Px"].clear();
  VectorBox_Double["LHE_Py"].clear();
  VectorBox_Double["LHE_Pz"].clear();
  VectorBox_Double["LHE_E"].clear();
  ...
  VectorBox_Double["Elec_Rnd"].clear();
  ...
  // VariableBox_Double["METEGClean_Significance"] = 0;
  ...
  // VariableBox_Double["METMUEGClean_Significance"] = 0;
  ...
  // VariableBox_Double["METMUEGCleanCor_Significance"] = 0;
  ...
  // VariableBox_Double["METUnCor_Significance"] = 0;
  ...
  // VariableBox_Double["METMUCleanCor_Significance"] = 0;
  ...
  VectorBox_Bool["Muon_isHighPt_calc"].clear();
  VectorBox_Bool["Muon_isHighTrkPt_calc"].clear();
  VectorBox_Bool["Muon_isLoose_calc"].clear();
  VectorBox_Bool["Muon_isMedium_calc"].clear();
  VectorBox_Bool["Muon_isTight_calc"].clear();

  VectorBox_Bool["Muon_isPF"].clear();
  VectorBox_Bool["Muon_isGlobal"].clear();
  VectorBox_Bool["Muon_isTracker"].clear();

  VectorBox_Double["Muon_ValidTrackHitFraction"].clear();
  VectorBox_Double["Muon_GlobalTrackChi2"].clear();
  VectorBox_Double["Muon_TrackerSTAPositionMatch"].clear();
  VectorBox_Double["Muon_TrackKink"].clear();
  VectorBox_Bool["Muon_TrackExist"].clear();
  VectorBox_Double["Muon_SegmentCompatibility"].clear();

  VectorBox_Double["Muon_GlobalMuonTrackChamberHit"].clear();
  VectorBox_Double["Muon_TunePGlobalMuonTrackChamberHit"].clear();
  VectorBox_Double["Muon_TunePpTError"].clear();
  VectorBox_Double["Muon_TunePpT"].clear();
  VectorBox_Double["Muon_StationsHasSegments"].clear();

  VectorBox_Double["Muon_dxy"].clear();
  VectorBox_Double["Muon_dB"].clear();
  VectorBox_Double["Muon_dz"].clear();
  VectorBox_Double["Muon_PixelHit"].clear();
  VectorBox_Double["Muon_TrackLayerWithHit"].clear();
