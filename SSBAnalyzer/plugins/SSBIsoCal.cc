...
double SSBIsoCal::EffArea2015(double abseleEta) {
  ...
  if (0.0000 <= eleEta && eleEta < 1.0000) {
    return 0.1752;
  } else if (1.0000 <= eleEta && eleEta < 1.4790) {
    return 0.1862;
  } else if (1.4790 <= eleEta && eleEta < 2.0000) {
    return 0.1411;
  } else if (2.0000 <= eleEta && eleEta < 2.2000) {
    return 0.1534;
  } else if (2.2000 <= eleEta && eleEta < 2.3000) {
    return 0.1903;
  } else if (2.3000 <= eleEta && eleEta < 2.4000) {
    return 0.2243;
  } else if (2.4000 <= eleEta && eleEta < 5.0000) {
    return 0.2687;
  } else {
    cout << "EffArea2015 Error !!! CHECK YOUR ELECTRON ETA VARIABLE!!!" << endl;
    return -999;
  }
}
