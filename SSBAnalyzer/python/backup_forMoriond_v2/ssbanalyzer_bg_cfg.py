...
#process.cloneGlobalMuonTagger.muons = cms.InputTag("slimmedMuons")
...
if runOnData:
  ...
  jecUncertainty="CMSAnalyses/SSBAnalyzer/data/Summer16_23Sep2016V3_DATA_Uncertainty_AK4PFchs.txt"
...
#  fname = 'file:/pnfs/knu.ac.kr/data/cms/store/user/sha/MiniAODSample/MC/80X_v2/ForMoriond/DYJetsToLL_M_50_HCALDebug/00312D7A-FEBD-E611-A713-002590DB923E.root'
  fileNames = cms.untracked.vstring('root://cms-xrd-global.cern.ch//store/mc/RunIISpring16MiniAODv2/SMS-T1tttt_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/MINIAODSIM/PUSpring16Fast_80X_mcRun2_asymptotic_2016_miniAODv2_v0-v1/00000/004A27F0-5132-E611-A936-02163E016171.root')
...
if runOnData:
  ...
  process.GlobalTag.globaltag = '80X_dataRun2_Prompt_v16' # for Prompt Data 
else:
...
if usePrivateSQlite:
    ...
    import os
    if runOnData:
      Eras="Summer16_23Sep2016V3_DATA"
      era="Summer16_23Sep2016V3_DATA"
    else:
...
##___________________________External JEC file________________________________||
    ...
    process.jec = cms.ESSource("PoolDBESSource",CondDBSetup,
                               connect = cms.string("sqlite_fip:CMSAnalyses/SSBAnalyzer/data/JECDir/Summer16_23Sep2016/Summer16_23Sep2016V3_MC/"+Eras+".db"),
                               toGet =  cms.VPSet(
            cms.PSet(
...
#                                    phiResolMCFile = cms.string('Summer16_23Sep2016V3_MC_PhiResolution_AK4PFchs.txt'),
#                                    phiResolDataFile = cms.string('Summer16_23Sep2016V3_DATA_PhiResolution_AK4PFchs.txt'),
#                                    ptResolSFFile = cms.string('Summer16_23Sep2016V3_MC_SF_AK4PFchs.txt'),
