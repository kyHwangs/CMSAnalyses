...
if usePrivateSQlite:
    ...
    import os
    if runOnData:
      Eras="Summer16_23Sep2016AllV3_DATA"
...
##___________________________External JEC file________________________________||
    ...
    process.jec = cms.ESSource("PoolDBESSource",CondDBSetup,
                               connect = cms.string("sqlite_fip:CMSAnalyses/SSBAnalyzer/data/JECDir/Summer16_23Sep2016/Summer16_23Sep2016AllV3_DATA/"+Eras+".db"),
                               toGet =  cms.VPSet(
            cms.PSet(
...
process.ssbanalyzer = cms.EDAnalyzer('SSBAnalyzer',
                                    ...
                                    #badGlobalMuonTagger  = cms.InputTag("noBadGlobalMuons",""),
                                    #badGlobalMuonTagger  = cms.InputTag("BadPFMuonFilter",""),
                                    bitsPat                    = cms.InputTag("TriggerResults","","RECO"),
